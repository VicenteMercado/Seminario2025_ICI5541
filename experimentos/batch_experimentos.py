    ...
    for run_idx in range(1, N_RUNS + 1):
        ...
        try:
            ...
            row = [
                ...
                solver_CSR,
                csr_oficial,
                resumen_global.get("cobertura_lugares"),
                resumen_global.get("csr_total_rel"),
                resumen_global.get("score_combinado"),
                resumen_global.get("precision_micro"),
                resumen_global.get("recall_micro"),
                resumen_global.get("f1_micro"),
