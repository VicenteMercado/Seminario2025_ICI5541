...
1. relaciones_espaciales.py se encarga de la extracción de las relaciones espaciales  

2. solver_grafos.py se encarga de recibir estas relaciones extraidas y pasarlas por un solver  
